...
using Control.API.Endpoints.Schedules;
...
namespace Control.API.E2ETests.Endpoints;

public class SchedulesEndpointTests(E2ETestWebAppFactory factory) : BaseE2ETest(factory)
{
    [Fact]
